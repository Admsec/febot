...
const sendLikeUsers = superVipUser.sendLikeUsers
...
for (let i = 0; i < vipUsers['sendLikeUsers'].length; i += 2) { 
  schedule.scheduleJob(`* * 0 * * *`, () => {
    sendlikes(vipUsers['sendLikeUsers'][i],
      vipUsers['sendLikeUsers'][i + 1])
  })
}